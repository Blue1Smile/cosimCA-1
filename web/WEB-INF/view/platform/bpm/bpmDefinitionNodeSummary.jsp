...
<head>
    <title>节点概要</title>
       ...
       <f:link href="Aqua/css/bootstrap.css"></f:link> 
        ...
        <script type="text/javascript" src="${ctx}/js/hotent/platform/bpm/MobileSetWindow.js" ></script>
   		...
   		<script type="text/javascript" src="${ctx}/js/hotent/platform/bpm/BpmNodeToolWindow.js" ></script>
<style>
.green-set{
...
<body>
	...
	<c:if test="${empty nodeId}">
		...
		<f:tab curTab="节点概要" tabName="flow" />
	</c:if>	
			...
			<form method="post" >
				...
				<table class="table-grid" style="width: 100%">
						<tr>
							...
							<!-- 
							<td rowspan="2" colspan="2" style="text-align: center;font-weight: bold;" class="panel-toolbar">人员设置</td>
							 -->
							<!-- 
							<td rowspan="2" colspan="2" style="text-align: center;font-weight: bold;" class="panel-toolbar">常用语设置</td>
							 -->
							
							<td colspan="5" style="text-align: center;font-weight: bold;" class="panel-toolbar">流程事件</td>
							<td rowspan="2" colspan="2" style="text-align: center;font-weight: bold;" class="panel-toolbar">流程规则</td>
							<td rowspan="2" colspan="2" style="text-align: center;font-weight: bold;" class="panel-toolbar">表单设置</td>
							<!-- 
														<td rowspan="2" colspan="2" style="text-align: center;font-weight: bold;" class="panel-toolbar">操作按钮</td>
							<td rowspan="2" colspan="2" style="text-align: center;font-weight: bold;" class="panel-toolbar">催办设置</td>
							<td rowspan="2" colspan="2" style="text-align: center;font-weight: bold;"  class="panel-toolbar">手机设置</td>
							 -->

							<td rowspan="2" colspan="2" style="text-align: center;font-weight: bold;"  class="panel-toolbar">工具设置</td>
						</tr>
						<tr>
							...
							<td nowrap="nowrap" style="text-align: center;font-weight: bold;" class="panel-toolbar">&nbsp;</td>
						</tr>
					...
					<c:forEach items="${nodeSetList}" var="nodeSet" varStatus="i">
						<tr>
							...
							<td>	
								<c:choose>
									<c:when test="${toolBpmNodeMap[nodeSet.setId]}">
										<span class="green-set">√</span>
									</c:when>
									<c:otherwise>
										<span class="red-set">×</span>

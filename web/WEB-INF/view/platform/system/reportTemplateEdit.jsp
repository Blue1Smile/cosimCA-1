	...
	<script type="text/javascript">
		$(function() {
			...
			$("a.save").click(function() {
				...
				if(path==''){
					$.ligerMessageBox.warn("提示","请上传模板文件");
				}else if(extName!='cpt'){
					$.ligerMessageBox.warn("提示","请选择*.cpt报表模板文件");
				}else{
			...
			function showResponse(responseText){
				var obj=new com.deloitte.form.ResultMessage(responseText);
				if(obj.isSuccess()){
					$.ligerMessageBox.success("提示",obj.getMessage(),function(){

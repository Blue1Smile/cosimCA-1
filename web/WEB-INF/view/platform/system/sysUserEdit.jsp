        ...
        <div id="tabMyInfo" class="panel-nav" style="overflow:hidden; position:relative;">
            <div title="基本信息" tabid="userdetail" icon="${ctx}/styles/default/images/resicon/user.gif">
                ...
                <table class="table-detail" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <%--<td rowspan="<c:if test="${not empty sysUser.userId}">9</c:if><c:if test="${empty sysUser.userId}">10</c:if>"--%>
                        <%--align="center" width="26%">--%>
                        <%--<div style="float:top !important;background: none;height: 24px;padding:0px 6px 0px 112px;">--%>
                        <%--<a class="link uploadPhoto" href="javascript:void(0)" onclick="addPic();">上传照片</a></div>--%>
                        ...
                        <td><c:if test="${bySelf==1}">
                            <input type="hidden" name="bySelf" value="1"></c:if>
                            <input type="text"
                                   <c:if test="${bySelf==1}">disabled="disabled"</c:if> id="account" name="account"
                                   value="${sysUser.account}" style="width:240px !important" class="inputText"/></td>
                    </tr>

                    <tr style="<c:if test="${not empty sysUser.userId}">display:none</c:if>">
                        <th>密 码: <span class="required">*</span></th>
                        <td><input type="password" id="password" name="password" value="${sysUser.password}"
                                   style="width:240px !important" class="inputText"/></td>
                    </tr>

                    <tr>
                        <th>用户姓名:</th>
                        <td><input type="text" id="fullname" name="fullname" value="${sysUser.fullname}"
                                   style="width:240px !important" class="inputText"/></td>
                    </tr>
                    <tr>
                        <th>用户性别:</th>
                        <td>
                            <select name="sex" class="select" style="width:245px !important">
                                <option value="1"
                                        <c:if test="${sysUser.sex==1}">selected</c:if> >男
                                </option>
                                <option value="0"
                                        <c:if test="${sysUser.sex==0}">selected</c:if> >女
                                </option>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th>是否过期:</th>
                        <td>
                            <select name="isExpired" class="select" style="width:245px !important"
                                    <c:if test="${bySelf==1}">disabled="disabled"</c:if>>
                                <option value="<%=SysUser.UN_EXPIRED %>"
                                        <c:if test="${sysUser.isExpired==0}">selected</c:if> >未过期
                                </option>
                                <option value="<%=SysUser.EXPIRED %>"
                                        <c:if test="${sysUser.isExpired==1}">selected</c:if> >已过期
                                </option>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="status" class="select" style="width:245px !important"
                                    <c:if test="${bySelf==1}">disabled="disabled"</c:if>>
                                <option value="<%=SysUser.STATUS_OK %>"
                                        <c:if test="${sysUser.status==1}">selected</c:if> >激活
                                </option>
                                <option value="<%=SysUser.STATUS_NO %>"
                                        <c:if test="${sysUser.status==0}">selected</c:if> >禁用
                                </option>
                                <option value="<%=SysUser.STATUS_Del %>"
                                        <c:if test="${sysUser.status==-1}">selected</c:if>>删除
                                </option>
                            </select>
                        </td>
                    </tr>
                    ...
                    <%--<tr>--%>
                    <%--<th>手 机:</th>--%>
                    <%--<td><input type="text" id="mobile" name="mobile" value="${sysUser.mobile}"--%>
                    <%--style="width:240px !important" class="inputText"/></td>--%>
                    <%--</tr>--%>

                    <%--<tr>--%>
                    <%--<th>电 话:</th>--%>
                    <%--<td><input type="text" id="phone" name="phone" value="${sysUser.phone}"--%>
                    <%--style="width:240px !important" class="inputText"/></td>--%>
                    <%--</tr>--%>
                        ...
                        <tr>
                            <td width="28%" valign="top" style="padding-left:2px !important;">
                                ...
                                <div class="panel-body" style="height:520px;overflow-y:auto;border:1px solid #6F8DC6;">
                                    ...
                                    <ul id="orgTree" class="ztree" style="width:200px;margin:0px; padding:0px;">
                                    </ul>
                                </div>
                            </td>
                                        ...
                                        <c:forEach items="${orgList}" var="orgItem">
                                            <tr trName="${orgItem.orgName}" id="${orgItem.orgId}"
                                                ...
                                                <td style="text-align: center;">
                                                        ${orgItem.orgName}<input type="hidden" name="orgId"
                                                                                 value="${orgItem.orgId}">
                                                </td>
                                                <td style="text-align: center;">
                                                    <input type="radio" name="orgIdPrimary" value="${orgItem.orgId}"
                                                           <c:if test='${orgItem.isPrimary==1}'>checked</c:if> />
                                                </td>
                                                <td style="text-align: center;">
                                                    <input type="checkbox" name="chargeOrgId" value="${orgItem.orgId}"
                                                           <c:if test='${orgItem.isCharge==1}'>checked</c:if>>
                                                </td>

                                                <td style="text-align: center;">
                                                    <a href="javascript:void(0)" onclick="delrow('${orgItem.orgId}')"
                                                       class="link del">移除</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                    ...
                    <%--<table align="center" cellpadding="0" cellspacing="0" class="table-grid">--%>
                        <%--<tr>--%>
                            <%--<td width="28%" valign="top" style="padding-left:2px !important;">--%>
                                ...
                                <%--</div>--%>
                                <%--<div class="panel-body" style="height:520px;overflow-y:auto;border:1px solid #6F8DC6;">--%>
                                    <%--<div id="posTree" class="ztree" style="width:200px;margin:0; padding:0;">--%>
                                    <%--</div>--%>
                                <%--</div>--%>
                            <%--</td>--%>
                            <%--<td width="3%" valign="middle" style="padding-left:2px !important;">--%>
                                    ...
                                    <%--<table id="posItem" class="table-grid" cellpadding="1" cellspacing="1">--%>
                                        ...
                                        <%--<c:forEach items="${posList}" var="posItem">--%>
                                            <%--<tr id="${posItem.posId}" style='cursor:pointer'>--%>
                                                <%--<td style="text-align: center;">--%>
                                                        <%--${posItem.posName}<input type="hidden" name="posId"--%>
                                                                                 <%--value="${posItem.posId}">--%>
                                                <%--</td>--%>
                                                <%--<td style="text-align: center;">--%>
                                                    <%--<input type="radio" name="posIdPrimary" value="${posItem.posId}"--%>
                                                           <%--<c:if test='${posItem.isPrimary==1}'>checked</c:if> />--%>
                                                <%--</td>--%>

                                                <%--<td style="text-align: center;">--%>
                                                    <%--<a href="javascript:void(0)" onclick="delrow('${posItem.posId}')"--%>
                                                       <%--class="link del">移除</a>--%>
                                                <%--</td>--%>
                                            <%--</tr>--%>
                                        <%--</c:forEach>--%>
                    ...
                    <table align="center" cellpadding="0" cellspacing="0" class="table-grid">
                        <tr>
                            <td width="28%" valign="top" style="padding-left:2px !important;">
                                ...
                                <div class="panel-body" style="height:520px;overflow-y:auto;border:1px solid #6F8DC6;">
                                    <div id="rolTree" class="ztree" style="width:200px;margin:0; padding:0;">
                                    </div>
                                </div>
                            </td>
                            <td width="3%" valign="middle" style="padding-left:2px !important;">
                                    ...
                                    <table id="rolItem" class="table-grid" cellpadding="1" cellspacing="1">
                                        ...
                                        <c:forEach items="${roleList}" var="rolItem">
                                            <tr trName="${rolItem.roleName}" id="${rolItem.roleId}"
                                                style="cursor:pointer">
                                                <td style="text-align: center;">
                                                        ${rolItem.roleName}<input type="hidden" name="roleId"
                                                                                  value="${rolItem.roleId}">
                                                </td>
                                                <td style="text-align: center;">
                                                        ${rolItem.systemName}
                                                </td>

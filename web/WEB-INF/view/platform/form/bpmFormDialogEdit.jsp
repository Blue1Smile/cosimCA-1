				...
				<form id="bpmFormDialogForm" method="post" action="save.ht">
					...
					<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
						<tr>
							...
							<td><input type="text" id="name" name="name" value="${bpmFormDialog.name}"  class="inputText"/></td>
							...
							<td colspan="3">
								<c:choose>
									<c:when test="${bpmFormDialog.id==0}">
										<input type="radio" name="style" value="0"  checked="checked"/>列表
										<input type="radio" name="style" value="1"  />树形
									</c:when>
									<c:otherwise>
										<c:choose>

...
<div id="all">
	...
	<!-- 主页面 开始 -->
	<div id="indexcontent">
		<div style="#ppt{width:100%; height:200px; overflow:hidden;}">
			<img src="${ctx}/images/banner-car.jpg"></img>
		</div>
		<!--主页面-左侧内容 开始 -->
		...
		<!--主页面-右侧内容 开始 -->
		<div class="index_right" style="margin-top:10px;">
			<!--在线能力-->
		...
		<div id="online_source" class="blue_box">
			...
			<div id="source_right">
				<div id="ulbox1" class="introduce_list">
					<div>
						<a href='${ctx}/cloud/cloudresource/showSoftResource.ht?softType=waiting'>
						<img src="${ctx}/images/rollPic/img_01.jpg" width=120 height=80	border=0>
						<br/>北航计算中心</a>
					</div>
					<div><a href='${ctx}/cloud/cloudresource/showComputingResource.ht?softType=computing' >
						<img src="${ctx}/images/rollPic/img_02.jpg" width=120 height=80	border=0>
						<br>天智平台计算中心</a>
					</div>
					<div><a href='${ctx}/cloud/cloudresource/showSoftResource.ht?softType=car' >
						<img src="${ctx}/images/rollPic/img_03.jpg" width=120 height=80 border=0>
						<br>Fluent</a>
					</div>
					<div><a href='${ctx}/cloud/cloudresource/showSoftResource.ht?softType=UG'>
						<img src="${ctx}/images/rollPic/img_04.jpg" width=120 height=80 border=0>
						<br>UG NX</a>
					</div>
					<div><a href='${ctx}/cloud/cloudresource/showSoftResource.ht?softType=material'>
						<img src="${ctx}/images/rollPic/img_05.jpg" width=120 height=80	border=0>
						<br>CPMD</a>
					</div>
					<div>
						<a href="#" onclick="window.open('https://hdx.shcloud.net/Citrix/netscaler/auth/clientDetectionPreInputs.aspx')">
					...
					<div>
						<a href='${ctx}/cloud/cloudresource/showSoftResource.ht?softType=material'>
			...
			<div id="last" class="blue_box">
				...
				<ul>
					<c:forEach items="${infoList}" var="c1" begin="0" end="4">
       	  				<li><a href="javascript:void(0);" onclick="toIndustry('${ctx}/cloud/system/enterprises/search_ind.ht?industry=${c1.industry}')" title="${c1.industry}">[${c1.industry}]</a> <a href="${ctx}/cloud/console/enterprise.ht?EntId=${c1.sysOrgInfoId}" class="link02" target="_blank" title="${c1.name}">${c1.name}</a></li>
       	  			</c:forEach>    
       	  			<c:forEach items="${infoList}" var="c2" begin="5" end="9">
       	  				<li><a href="${ctx}/cloud/system/enterprises/search_ind.ht?industry=${c1.industry}" title="${c2.industry}">[${c2.industry}]</a> <a href="${ctx}/cloud/console/enterprise.ht?EntId=${c2.sysOrgInfoId}" class="link02" target="_blank" title="${c2.name}">${c2.name}</a></li>
       	  			</c:forEach> 
					<p class="clear"></p>
				</ul>
				</div>
		...
		<div class="index_right">
			<div id="partner" class="blue_box">
				...
				<ul>
        	  		<li><a href="http://www.cloud-valley.com">云基地网站</a></li>
		            <li><a href="http://www.china-cloud.com">中云网</a></li>
		            <li><a href="http://www.chinaskycloud.com">天云融创 </a></li>
        		    <li><a href="${ctx}/car_mainpage.ht">中国汽车工业协会</a></li>		            
        		    <li><a href="#" class="link02">鹏博士数据中心 </a></li>
		        </ul>
			</div>
		</div>
		<div class="clear"></div>

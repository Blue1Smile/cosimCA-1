                        ...
                        <form class="form-horizontal" name="excelImportForm"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <input class="btn btn-default btn-block" id="excel_file" type="file" name="filename"
                                               accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel"/>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <input class="btn btn-primary btn-block" id="excel_button" type="submit" value="导入Excel"/>
                            </div>
                        </form>
                    </div>
                </div>

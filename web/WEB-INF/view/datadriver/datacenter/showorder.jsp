...
<div class="tbar-title">
  <span class="tbar-label">查看订购数据</span>
</div>
<div class="panel">
  <div class="panel-top">
  ...
  <div class="panel-body">
    ...
    <!--20161202-->
    <form id="datacentreForm" name="datacentreForm" method="post" action="submitpublish.ht" enctype="multipart/form-data">
        ...
        <table id="PrivateData" class="table-grid table-list"  cellpadding="1" cellspacing="1">
          ...
          <c:forEach items="${privateDataList}" var="privateDataItem" >
            ...
            <tr  style="cursor:pointer">
              ...
              <td style="text-align: center;" >
                <input type="hidden"  name="ddDataDescription" value="${privateDataItem.ddDataDescription}">

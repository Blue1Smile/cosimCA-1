...
<head>
    ...
    <style type="text/css">
        html,body{ padding:0px; margin:0; width:100%;height:100%;overflow: auto;}
...
<div id="layout">
    ...
    <div position="center">
        <iframe id="listFrame" src="${ctx}/datadriver/datacenter/publishOrderData.ht" frameborder="no" width="100%" height="100%"></iframe>
    </div>
</div>

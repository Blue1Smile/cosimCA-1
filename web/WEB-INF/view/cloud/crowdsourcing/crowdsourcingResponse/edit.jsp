...
<head>
	...
	<script type="text/javascript">
		...
		$("a.agree").click(function() {
			...
			$('#crowdsourcingResponseForm').attr("action","complete.ht");
			frm.setData();
			frm.ajaxForm(options);
			if(frm.valid()){
				form.submit();
		...
		<form id="crowdsourcingResponseForm" method="post" action="save.ht">
			...
			<table class="table-grid table-list" cellpadding="1" cellspacing="1" id="crowdsourcingResponseDetail" formType="window" type="sub">
				...
				<c:forEach items="${crowdsourcingResponseDetailList}" var="crowdsourcingResponseDetailItem" varStatus="status">
				    <tr type="subdata">
					    <td style="text-align: center" name="attachmentName">${crowdsourcingResponseDetailItem.attachmentName}</td>
					    ...
					    <td style="text-align: center" name="uploadId">${crowdsourcingResponseDetailItem.uploadId}</td>
					    ...
					    <td style="text-align: center" name="operatingAuthority">${crowdsourcingResponseDetailItem.operatingAuthority}</td>

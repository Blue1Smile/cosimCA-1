	...
	<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					<div class="group">
						<f:a alias="searchSysUser" css="link search" id="btnSearch">查询</f:a>
					</div>
					<div class="l-bar-separator"></div>
					<div class="group">
						<f:a alias="addSysUser" css="link add" href="edit.ht">添加</f:a>
					</div>
					<div class="l-bar-separator"></div>
					<div class="group">
						<f:a alias="delSysUser" css="link del" action="del.ht">删除</f:a>
					</div>
					<div class="l-bar-separator"></div>
				</div>	
			</div>
		...
		<div class="panel-body">
			    ...
			    <display:table name="sysUserList" id="sysUserItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1"  export="true"  class="table-grid">
					...
					<display:column property="shortAccount" title="短帐号" sortable="true" sortName="shortAccount" style="text-align:left"></display:column>
					...
					<%--
					 ...
					 --%>
						<f:a alias="updateSysUserInfo" css="link edit" href="edit.ht?userId=${sysUserItem.userId}">编辑</f:a>
						<f:a alias="sysUserInfo" css="link detail" href="get.ht?userId=${sysUserItem.userId}">明细</f:a>
						<%-- /////ht del b
						...
						/////ht del e --%>
						<f:a alias="resetSysUserPwd" css="link resetPwd" href="resetPwdView.ht?userId=${sysUserItem.userId}">重置密码</f:a>

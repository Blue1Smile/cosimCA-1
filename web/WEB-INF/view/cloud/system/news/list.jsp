	...
	<div class="panel">
		<div class="panel-top">
			<div class="tbar-title">
				<span class="tbar-label">新闻公告管理列表</span>
			</div>
		...
		<div class="panel-body">
		    ...
		    <display:table name="newsList" id="newsItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" export="true"  class="table-grid">

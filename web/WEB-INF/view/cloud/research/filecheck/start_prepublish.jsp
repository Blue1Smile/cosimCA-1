	...
	<script type="text/javascript">
  	...
  	function _callBackSelectedRoles(rows){
  		...
  		for(var k=0; k<rows.length; k++){
			...
			checkerIds = checkerIds+row.companyId+","+row.roleId+";";
		}
	$('input[name="currentEnterpIds"]').val(checkerNames);
	$('input[name="currentUserIds"]').val(checkerIds);
    rolesChooser.close();
}
...
<div class="panel">
	...
	<div class="panel-body">
		<form id="resFilecheckForm" method="post" action="save_prepublish.ht">
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0" type="main">
				...
				<tr style="display: none;">
					<th width="20%">审签者ID: </th>
					<td ><input style="width: 90%" type="text"  readonly class="r"  id="currentUserIds" name="currentUserIds" class="inputText" /></td>
				</tr>
				<tr style="display: none;">

		...
		<form id="logisticPlanForm" method="post" action="save.ht">
			...
			<c:if test="${logisticPlan.logisticsModel==2}">
				<tr type="subdata">
					    ...
					    <td style="text-align: center" name="shipEnterpName" class="shipEnterpName"><span id="selectship" ><input type="hidden" id="selectValidate" value="" validate="{required:true}"/>	</span><a href="#" onclick="add_supps('selectship')"  class="link detail" >选择</a></td>

	...
	<div class="panel-body">
		<form id="saleOrderForm" method="post" action="save2.ht">
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0" type="main">
				...
				<tr style="display:none">
					...
					<td><input size="35" type="text" id="en_id"   readonly="readonly" name="purenterpId" value="${saleOrder.purenterpId}"  class="inputText" validate="{required:false,number:true }"  /></td>
			    ...
			    <tr>
					...
					<td><input size="35" type="text"  readonly="readonly" id="en_name" name="purenterpName" value="${saleOrder.purenterpName}"  class="inputText" validate="{required:true,maxlength:96}"  />
					</td>
					<th style="width:120px">采购企业联系人姓名: </th>
					<td><input size="35" type="text"  readonly="readonly" id="purenterpUsername" name="purenterpUsername" value="${saleOrder.purenterpUsername}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
				<tr>
					...
					<td><input size="35" type="text"  readonly="readonly" id="suppenterpName" name="suppenterpName" value="${saleOrder.suppenterpName}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
					<th style="width:120px">供应商联系人姓名: </th>
					<td ><input size="35" type="text"  readonly="readonly" id="suppenterpUsername" name="suppenterpUsername" value="${saleOrder.suppenterpUsername}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
				<tr style="display:none">
					<th style="width:120px">合同单id: </th>
					<td><input size="35" type="text" id="contractId" name="contractId" value="${saleOrder.contractId}"  class="inputText" /></td>
				</tr> 
				  <!--   
				<tr>
					<th style="width:120px">供应商联系人ID: </th> 
					<td><input size="35" type="text" id="suppenterpUserid" name="suppenterpUserid" value="${saleOrder.suppenterpUserid}"  class="inputText" validate="{required:false,number:true }"  /></td>
		 	       </tr>
				<tr>
				<tr>
				...
				<tr>
					...
					<td><input size="35" type="text" id="receivewarehouseName" name="receivewarehouseName" value="${saleOrder.receivewarehouseName}"  class="inputText" validate="{required:false,maxlength:768}"  /></td>
				</tr>
				
				<tr>
					<th style="width:120px">收货仓库详细地址: </th>
					<td><input size="35" type="text" id="receivewarehouseAddress" name="receivewarehouseAddress" value="${saleOrder.receivewarehouseAddress}"  class="inputText" validate="{required:false,maxlength:768}"  /></td>
				</tr>
				<tr>
					<th style="width:120px">收货地址邮编: </th>
					<td><input size="35" type="text" id="postcode" name="postcode" value="${saleOrder.postcode}"  class="inputText" validate="{required:false,number:true }"  /></td>
				</tr>
				...
				<tr>
					...
					<td><input size="35" type="text" id="receiverName" name="receiverName" value="${saleOrder.receiverName}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
				<tr>
					<th style="width:120px">收货人手机号: </th>
					<td><input size="35" type="text" id="receiverPhone" name="receiverPhone" value="${saleOrder.receiverPhone}"  class="inputText" validate="{required:false,number:true }"  /></td>
				</tr>
				<tr>
					<th style="width:120px">收货人邮箱: </th>
					<td><input size="35" type="text" id="receiverMail" name="receiverMail" value="${saleOrder.receiverMail}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
				<tr>
					<th style="width:120px">操作者ID: </th>
					<td><input size="35" type="text" id="operatorId" name="operatorId" value="${saleOrder.operatorId}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr> 
				-->
		...
		<tr>
				...
				<c:forEach items="${saleOrderDetailList}" var="saleOrderDetailItem" varStatus="status">
				    <tr type="subdata">
					    <td style="text-align: center" name="materielId">${saleOrderDetailItem.materielId}</td>
					    ...
					    <td style="text-align: center" name="materielLev">${saleOrderDetailItem.materielLev}</td>

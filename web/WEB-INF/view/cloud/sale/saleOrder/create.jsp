...
<!-- 		<div class="panel-toolbar">
		...
		<form id="saleOrderForm" method="post" action="save.ht">
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0" type="main">
				<tr>
					...
					<td><input readonly class="r"  type="text" id="code" name="code" value="${saleOrder.code}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
				<tr>
					<th width="20%">制单日期: </th>
					<td><input readonly class="r"  type="text" id="operateDate" name="operateDate" value="<fmt:formatDate value='${saleOrder.operateDate}' pattern='yyyy-MM-dd'/>" class="inputText date" validate="{date:true}" /></td>
					<th width="20%">制单人姓名: </th>
					<td><input readonly class="r"  type="text" id="operatorName" name="operatorName" value="${saleOrder.operatorName}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
				
				<tr>
					<th width="20%">来源单据ID: </th>
					<td><input readonly class="r"  type="text" id="sourceformId" name="sourceformId" value="${saleOrder.sourceformId}"  class="inputText" validate="{required:false,number:true }"  /></td>
					<th width="20%">来源单据类型: </th>
					<td><input readonly class="r"  type="text" id="sourceformType" name="sourceformType" value="${saleOrder.sourceformType}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
			
		
				<tr>
					<th width="20%">来源单据编号: </th>
					<td><input readonly class="r"  type="text" id="sourceformCode" name="sourceformCode" value="${saleOrder.sourceformCode}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
					<th width="20%">预付款: </th>
					<td><input readonly class="r"  type="text" id="advancePay" name="advancePay" value="${saleOrder.advancePay}"  class="inputText" validate="{required:false}"  /></td>
				</tr>
				
				<tr>
					<th width="20%">预付款说明: </th>
					<td><input readonly class="r"  type="text" id="advancepayNotes" name="advancepayNotes" value="${saleOrder.advancepayNotes}"  class="inputText" validate="{required:false,maxlength:768}"  /></td>
					<th width="20%">运费承担方: </th>
					<td><input readonly class="r"  type="text" id="freightBearer" name="freightBearer" value="${saleOrder.freightBearer}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
					...
					<th width="20%">币种: </th>
						<td>
						<select  readonly class="r"  id="currencyType" name="currencyType" value="${saleOrder.currencyType}" validate="{required:false,maxlength:96}">
							<option>人民币</option>
							<option>美元</option>
							<option>日元</option>
							<option>英镑</option>
					...
					<th width="20%">总金额: </th>
					<td><input  readonly class="r" type="text" id="sumPrice" name="sumPrice" value="${saleOrder.sumPrice}"  class="inputText" validate="{required:false}"  /></td>
				</tr>
				<tr>
					<th width="20%">支付方式: </th>
					<td>
						<input  readonly class="r" type="text" id="payType" name="payType" value="${saleOrder.payType}"  class="inputText" validate="{required:false}"  />
					</td>
					<th width="20%">票据要求: </th>
					<td>
						<input  readonly class="r" type="text" id="billType" name="billType" value="${saleOrder.billType}"  class="inputText" validate="{required:false}"  />
					</td>
				</tr>
	...
	<!-- 	<td><input type="text" id="currencyType" name="currencyType" value="${saleOrder.currencyType}"  class="inputText" validate="{required:false,maxlength:96}"  /></td> -->			
		...
		<!--	<tr>
					...
					<input type="hidden" id="purenterpId" name="purenterpId"  value="${saleOrder.purenterpId}"  class="inputText" validate="{required:false,number:true }"  />
				...
				<tr>
					...
					<td><input  readonly class="r" type="text" id="purenterpName" name="purenterpName"  readonly="readonly" value="${saleOrder.purenterpName}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
					<th width="20%">采购企业联系人姓名: </th>
					<td><input  readonly class="r" type="text" id="purenterpUsername" name="purenterpUsername" value="${saleOrder.purenterpUsername}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
				
				<tr>
					<th width="20%">供应商企业名称: </th>
					<td><input  readonly class="r"  type="text" id="suppenterpName" name="suppenterpName" value="${saleOrder.suppenterpName}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
					<th width="20%">供应商联系人姓名: </th>
					<td><input  readonly class="r"  type="text" id="suppenterpUsername" name="suppenterpUsername" value="${saleOrder.suppenterpUsername}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
			<!-- 	<tr>
		...
		<!-- 		<tr>
				...
				<tr>
					...
					<td><input  readonly class="r"  type="text" id="receivewarehouseName"  readonly="readonly" name="receivewarehouseName" value="${saleOrder.receivewarehouseName}"  class="inputText" validate="{required:false,maxlength:768}"  /></td>
					<th width="20%">收货仓库详细地址: </th>
					<td><input  readonly class="r" type="text" id="receivewarehouseAddress"  readonly="readonly" name="receivewarehouseAddress" value="${saleOrder.receivewarehouseAddress}"  class="inputText" validate="{required:false,maxlength:768}"  /></td>
				</tr>
				
				
				<tr>
					<th width="20%">收货地址邮编: </th>
					<td><input readonly class="r"  type="text" id="postcode" name="postcode"  readonly="readonly" value="${saleOrder.postcode}"  class="inputText" validate="{required:false,number:true }"  /></td>
					<th width="20%">收货人姓名: </th>
					<td><input readonly class="r"  type="text" id="receiverName"  readonly="readonly" name="receiverName" value="${saleOrder.receiverName}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
		...
		<!--  		<tr>
				...
				<input type="hidden" id="operatorId" name="operatorId" value="${saleOrder.operatorId}"  class="inputText" validate="{required:false,maxlength:96}"  />
				<tr>
				...
				<tr>
					<th width="20%">税率(%): </th>
					<td><input type="text" id="taxRate" name="taxRate"  readonly value="${saleOrder.taxRate}"  class="r" validate="{required:false,number:true}"  /></td>
				</tr>
...
<!-- 						<div class="group" align="left">
		...
		<tr>
				...
				<c:forEach items="${saleOrderDetailList}" var="saleOrderDetailItem" varStatus="status">
				    <tr type="subdata">
					    ...
					    <td style="text-align: center" name="materielName">${saleOrderDetailItem.materielName}</td>
					     ...
					     <td style="text-align: center" name="model">${saleOrderDetailItem.model}</td>
					    <td style="display:none" name="materielLev">${saleOrderDetailItem.materielLev}</td>
					    <td style="display:none" name="attributeInfo">${saleOrderDetailItem.attributeInfo}</td>
					    ...
					    <td style="text-align: center" name="bargain">${saleOrderDetailItem.bargain}</td>
			...
			<!-- 		    <td style="text-align: center">
						...
						<input type="hidden" name="bargain" value="${saleOrderDetailItem.bargain}"/>
	...
	<form id="saleOrderDetailForm" style="display:none">
		<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
		 <tr>
			...
			<tr>
				<th width="20%">议价: </th>
				<td><input type="text" name="bargain" value=""  class="inputText" validate="{required:false}"/></td>
			</tr>
			<tr>
				<th width="20%">总价: </th>

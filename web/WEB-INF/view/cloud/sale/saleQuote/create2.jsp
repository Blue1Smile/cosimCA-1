		...
		<form id="saleQuoteForm" method="post" action="save.ht">
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0" type="main">
				...
				<tr>
					...
					<td><input size="35" readonly="readonly"  type="text" id="offerEndtime" name="offerEndtime" value="<fmt:formatDate value='${saleQuote.offerEndtime}' pattern='yyyy-MM-dd'/>" class="inputText date" validate="{date:true}" /></td>
				</tr>
				<tr>
				...
				<tr>					
					...
					<td><input size="35"  readonly="readonly" type="text" id="sourceformType" name="sourceformType" value="${saleQuote.sourceformType}"  class="inputText" validate="{required:false }"  /></td>
					<th style="width:120px">来源单据编码: </th>
					<td><input size="35"  readonly="readonly" type="text" id="sourceformCode" name="sourceformCode" value="${saleQuote.sourceformCode}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
				<tr>
					<th style="width:120px">采购企业ID: </th>
					<td><input size="35"  readonly="readonly"  type="text" id="purenterpId" name="purenterpId" value="${saleQuote.purenterpId}"  class="inputText" validate="{required:false,number:true }"  /></td>
					<th style="width:120px">采购企业: </th>
					<td><input size="35" type="text"   readonly="readonly" id="purenterpName" name="purenterpName" value="${saleQuote.purenterpName}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
				<tr>
					<th style="width:120px">采购企业联系人ID: </th>
					<td><input size="35" type="text" id="purenterpUserid"  readonly="readonly" name="purenterpUserid" value="${saleQuote.purenterpUserid}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
					<th style="width:120px">采购企业联系人姓名: </th>
					<td><input size="35" type="text" id="purenterpUsername"  readonly="readonly" name="purenterpUsername" value="${saleQuote.purenterpUsername}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
				<tr>
			...
			<!--  		<td><select id="currencyType" name="currencyType">
						...
						<option value='$' ${selected} >美&nbsp;元</option>
						 ...
						 -->
						 <td><input size="35" type="text" id="currencyType" name="currencyType" value="${saleQuote.currencyType}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				...
				<tr>
					...
					<td colspan="3"><input size="35" type="text"  readonly="readonly" id="purenqReleasedate" name="purenqReleasedate" value="<fmt:formatDate value='${saleQuote.purenqReleasedate}' pattern='yyyy-MM-dd'/>" class="inputText date" validate="{date:true}" /></td>
				</tr>
			...
			<table class="table-grid table-list" cellpadding="1" cellspacing="1" id="saleQuoteDetail" formType="window" type="sub">
				...
				<c:forEach items="${saleQuoteDetailList}" var="saleQuoteDetailItem" varStatus="status">
				    <tr type="subdata">
					    <td style="display:none" name="materielId">${saleQuoteDetailItem.materielId}</td>
					    ...
					    <td style="display:none" name="materielLev">${saleQuoteDetailItem.materielLev}</td>
	...
	<form id="saleQuoteDetailForm" style="display:none">
		<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
			<tr style="display:none">
				...
				<td><input size="35" type="text"  readonly="readonly" name="materielId" value=""  class="inputText" validate="{required:false,number:true }"/></td>
			</tr>
			<tr>
				<th style="width:120px">物品名: </th>
				<td><input size="35" type="text" name="materielName"  readonly="readonly" value=""  class="inputText" validate="{required:false,maxlength:768}"/></td>
			</tr>
			<tr style="display:none">
				<th style="width:120px">物品分类: </th>
				<td><input size="35"  readonly="readonly" type="text" name="materielLev" value=""  class="inputText" validate="{required:false,number:true }"/></td>
			</tr>
			<tr>
				<th style="width:120px">属性说明: </th>
				<td><input size="35"  readonly="readonly" type="text" name="attributeInfo" value=""  class="inputText" validate="{required:false}"/></td>
			</tr>
			<tr>
				<th style="width:120px">单位: </th>
				<td><input size="35"  readonly="readonly" type="text" name="unit" value=""  class="inputText" validate="{required:false,maxlength:96}"/></td>
			</tr>
			<tr>
				<th style="width:120px">订单数量: </th>
				<td><input size="35"  readonly="readonly" type="text" name="orderNum" value=""  onblur="getSumPrice(this);" class="inputText" validate="{required:false,number:true }"/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input size="35"  readonly="readonly" type="text" name="deliveryEnddate" value="" class="inputText date" validate="{date:true}"/></td>
			</tr>
			...
			<tr>
				...
				<td><input size="35"  readonly="readonly" type="text" name="materielCode" value=""  class="inputText" validate="{required:false,maxlength:192}"/></td>
			</tr>
		</table>
	</form>
</div>

    ...
    <c:forEach items="${leftResourcesList}" var="leftResourcesItem">
        <ul class="list-group">
            <li class="list-group-item">
                ...
                <a href="javascript:openFrame('${leftResourcesItem.defaultUrl}');" title="暂不可用">${leftResourcesItem.resName}</a>
                </c:when>
                <c:otherwise>
                <a href="javascript:openFrame('${ctx}${leftResourcesItem.defaultUrl}');" title="暂不可用">${leftResourcesItem.resName}</a>
                </c:otherwise>
                </c:choose>

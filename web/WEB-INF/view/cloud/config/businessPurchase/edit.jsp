	...
	<div class="panel-body">
		<form id="businessPurchaseForm" method="post" action="save.ht">
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0" type="main">
				...
				<tr>
					<th width="20%">商机名称: </th>
					<td><input type="text" id="name" name="name" value="${businessPurchase.name}"  class="inputText" style="width:550px;" validate="{required:true,maxlength:384}"  /></td>
				</tr>
				<tr>
					<th width="20%">开始时间: </th>
					<td><input type="text" id="startTime" name="startTime" value="<fmt:formatDate value='${businessPurchase.startTime}' pattern='yyyy-MM-dd'/>" class="inputText date" validate="{date:true}" /></td>
				</tr>
				<tr>
					<th width="20%">结束时间: </th>
					<td><input type="text" id="endTime" name="endTime" value="<fmt:formatDate value='${businessPurchase.endTime}' pattern='yyyy-MM-dd'/>" class="inputText date" validate="{date:true}" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<input id="image" name="image" type="hidden"
									value="${businessPurchase.image}"> <a
				...
				<tr>
					<th width="20%">采购数量: </th>
					<td><input type="text" id="purnum" name="purnum" value="${businessPurchase.purnum}"  class="inputText" validate="{required:true,number:true }"  /></td>
				</tr>
			
				<tr>
					<th width="20%">交货期要求: </th>
					<td>
					<textarea rows="3" cols="100"  id="jhqyq" name="jhqyq" style="width:550px;">${businessPurchase.jhqyq}</textarea>
					</td>
				</tr>
				<tr>
					<th width="20%">供应商资质要求: </th>
					<td>
					<textarea rows="3" cols="100"  id="gyszzyq" name="gyszzyq" style="width:550px;">${businessPurchase.gyszzyq}</textarea>

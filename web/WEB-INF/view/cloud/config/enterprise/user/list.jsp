	...
	<div class="panel">
		...
		<div class="panel-body">
			    ...
			    <display:table name="sysUserList" id="sysUserItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1"  export="false"  class="table-grid">
					...
					<display:column property="shortAccount" title="人员角色" sortable="true" sortName="shortAccount" style="text-align:left"></display:column>
					...
					<%--
						...
						<f:a alias="userEnterpriseInfo" css="link detail" href="get.ht?userId=${sysUserItem.userId}">明细</f:a>
						<%-- /////ht del b

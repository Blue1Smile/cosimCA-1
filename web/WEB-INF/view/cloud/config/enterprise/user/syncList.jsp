...
<head>
	...
	function syncToLdap(){
		...
		this.sync=function(conf){
			...
			var url=__ctx + "/cloud/config/enterprise/user/syncToLdap.ht";
				...
				<div class="panel-top">
					...
					<div class="panel-toolbar">
						<div class="toolBar">
							...
							<div class="l-bar-separator"></div>
							<div class="group">
								<f:a alias="syncToLdap" css="link reload" onclick="syncToLdap()">同步</f:a>
							</div>
						</div>	
					</div>
				<div class="panel-search">
							<form id="searchForm" method="post" action="syncList.ht">
									<div class="row">
										...
										<span class="label">创建时间从:</span><input type="text" name="Q_begincreatetime_DL"  class="inputText date" style="width:9%" value="${param['Q_begincreatetime_DL']}"/>
										<span class="label">至</span><input type="text" name="Q_endcreatetime_DG"  class="inputText date" style="width:9%" value="${param['Q_endcreatetime_DG']}"/>

	...
	*/
	...
	<body>
		<form id="capabilityForm" method="post" action="save.ht">
						...
						<div js_flag="sale-info">
							...
							<div class="product-info-form">
								...
								<div class="row">
									...
									<div class="cell">
										<input id="name" name="name" type="text" class="text"   style="width: 380px;" validate="{required:true,maxlength:40}" ></input>
									</div>
								...
								<div class="row">
									...
									<div class="cell">
										<input id="prokey" name="prokey" type="text" class="text"  style="width: 100px;" validate="{required:true,maxlength:10}" />
									</div>
								...
								<div class="row">
									...
									<div class="cell">
										<input id="useScope" name="useScope" type="text" class="text w80" value="" validate="{required:true,maxlength:40}" />
							...
							<div class="row pt16">
								...
								<input type="button" class="submit" id="save" value="确认发布" >
								<span class="btn-next" style="width: 120px;">
			...
			<input id="currentLevl" name="currentLevl" type="hidden" value="${levl1}"></input>
			<input id="typeId" name="typeId" type="hidden" value="${classid}"></input>
			<input id="typeName" name="typeName" type="hidden" value="${className}"></input>
			<input id="pic" name="pic" type="hidden"  ></input>
			<input id="publishState" name="publishState" type="hidden"></input>
		</form>
	</body>
</html>
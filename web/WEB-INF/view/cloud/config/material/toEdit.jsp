...
<script type="text/javascript">
	...
	function preview() {
		CommonDialog("materialCatalogTreeOwer", function(data) {
					...
					<div js_flag="sale-info">
						<div class="title">
							...
							<ul class="path">
								...
								<li class="active"><span>2</span>修改物品详情</li>
...
<!-- 							</div> -->
							...
							<div class="row">
								...
								<div class="cell">
									<input type="text" id="name" name="name" class="text"
										value="${material.name }" style="width: 380px;"
										validate="{required:true,maxlength:768}" />
								</div>
								<div id="pronameTip"></div>
							...
							<div class="row">
								...
								<div class="cell">
									<input id="code" name="code" type="text" class="text"
										value="${material.code }" style="width: 180px;"
							...
							<div class="row">
								...
								<div class="cell">
									<input id="industryCode" name="industryCode" type="text"
										class="text" value="${material.industryCode }"
										style="width: 100px;"
										validate="{required:false,maxlength:192}" />
								</div>
											...
											<c:if test="${p.propertyType=='1'}">
												<div class="cell">
													<input id="property${p.id}" name="property${p.id}"
														class="text" maxlength="80" type="text">
												</div>
											</c:if>
							...
							<div class="row">
								...
								<input id="model" name="model" type="text" class="text"
									style="width: 180px;" value="${material.model}"
									validate="{required:true,maxlength:192 }">
							</div>
							...
							<div class="row">
								...
								<div class="cell">
									<input id="price" value="${material.price }" name="price"
										type="text" class="text w80"
							...
							<div class="row">
								...
								<div class="cell" js_picarea="true">
									...
									<div class="addproduct-pic" id="picView">
										<c:if test="${material.pic != '' }">
											<img src="${ctx}${material.pic}"
							...
							<div class="row">
								...
								<div class="cell">
									<div class="postbox" id="postbox">
										<textarea id="txtHtml" name="html">${material.info }</textarea>
									</div>
								</div>
							</div>
							...
							<div class="row pt16">
								...
								<input type="hidden" name="typeClass"
									value="${material.typeClass}" /> <input type="hidden"
									name="id" value="${material.id}" /> <input id="info"
									name="info" type="hidden" value="${material.info }"> <input
									id="publishState" name="publishState" type="hidden"
									value="${material.publishState }"> <input id="pic"
									name="pic" type="hidden" value="${material.pic }"> <input
									name="levlType" type="hidden" value="${levltype}"> <input
									name="levlSeq" type="hidden" value="${levlseq}"> <input
									type="button" class="submit" id="save" value="确认保存">

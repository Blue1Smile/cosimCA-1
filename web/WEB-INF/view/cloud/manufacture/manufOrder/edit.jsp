		...
		<form id="manufOrderForm" method="post" action="save.ht">
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0" type="main">
				...
				<tr>
					...
					<td><input type="text" id="enquiryenterpriseId" name="enquiryenterpriseId" value="${manufOrder.enquiryenterpriseId}"  class="inputText" validate="{required:false,number:true }"  /></td>
				
					<th width="20%">委托企业: </th>
					<td><input type="text" id="enquiryenterpriseName" name="enquiryenterpriseName" value="${manufOrder.enquiryenterpriseName}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
				<tr>
					<th width="20%">委托企业联系人ID: </th>
					<td><input type="text" id="enquiryenterpriseUserid" name="enquiryenterpriseUserid" value="${manufOrder.enquiryenterpriseUserid}"  class="inputText" validate="{required:false,number:true }"  /></td>
				
					<th width="20%">委托企业联系人: </th>
					<td><input type="text" id="enquiryenterpriseUsername" name="enquiryenterpriseUsername" value="${manufOrder.enquiryenterpriseUsername}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" id="enterpriseId" name="enterpriseId" value="${manufOrder.enterpriseId}"  class="inputText" validate="{required:false,number:true }"  /></td>
				</tr>
				<tr>
					<th width="20%">受托企业名称: </th>
					<td><input type="text" id="enterpriseName" name="enterpriseName" value="${manufOrder.enterpriseName}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				...
				<tr>
					...
					<td><input type="text" id="receivewarehouseId" name="receivewarehouseId" value="${manufOrder.receivewarehouseId}"  class="inputText" validate="{required:false,number:true }"  /></td>
				
					<th width="20%">收货仓库名: </th>
					<td><input type="text" id="receivewarehouseName" name="receivewarehouseName" value="${manufOrder.receivewarehouseName}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
				<tr>
					<th width="20%">收货仓库地址: </th>
					<td><input type="text" id="receivewarehouseAddress" name="receivewarehouseAddress" value="${manufOrder.receivewarehouseAddress}"  class="inputText" validate="{required:false,maxlength:768}"  /></td>
				
					<th width="20%">收货联系人ID: </th>
					<td><input type="text" id="receivewarehouseUserid" name="receivewarehouseUserid" value="${manufOrder.receivewarehouseUserid}"  class="inputText" validate="{required:false,number:true }"  /></td>
				</tr>
				<tr>
					<th width="20%">收货联系人名: </th>
					<td><input type="text" id="receivewarehouseUsername" name="receivewarehouseUsername" value="${manufOrder.receivewarehouseUsername}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
			...
			<table class="table-grid table-list" cellpadding="1" cellspacing="1" id="manufOrderDetail" formType="window" type="sub">
				...
				<c:forEach items="${manufOrderDetailList}" var="manufOrderDetailItem" varStatus="status">
				    <tr type="subdata">
					    <td style="text-align: center" name="materialCode">${manufOrderDetailItem.materialCode}</td>
					    <td style="text-align: center" name="materialCodenotation">${manufOrderDetailItem.materialCodenotation}</td>
					    <td style="text-align: center" name="materialName">${manufOrderDetailItem.materialName}</td>
					    <td style="text-align: center" name="materialSpec">${manufOrderDetailItem.materialSpec}</td>
					    <td style="text-align: center" name="materialUnit">${manufOrderDetailItem.materialUnit}</td>
					    <td style="text-align: center" name="materialNumber">${manufOrderDetailItem.materialNumber}</td>
					    <td style="text-align: center" name="price">${manufOrderDetailItem.price}</td>
					    <td style="text-align: center" name="sumPrice">${manufOrderDetailItem.sumPrice}</td>
						<td style="text-align: center" name="deliveryEnddate"><fmt:formatDate value='${manufOrderDetailItem.deliveryEnddate}' pattern='yyyy-MM-dd'/></td>								
						<td style="text-align: center" name="predeliveryEnddate"><fmt:formatDate value='${manufOrderDetailItem.predeliveryEnddate}' pattern='yyyy-MM-dd'/></td>								
					    <td style="text-align: center" name="crafts">${manufOrderDetailItem.crafts}</td>
					    <td style="text-align: center" name="craftAttachment">${manufOrderDetailItem.craftAttachment}</td>
					    <td style="text-align: center" name="bom">${manufOrderDetailItem.bom}</td>
						<td style="text-align: center" name="planStartdate"><fmt:formatDate value='${manufOrderDetailItem.planStartdate}' pattern='yyyy-MM-dd'/></td>								
						<td style="text-align: center" name="planEnddate"><fmt:formatDate value='${manufOrderDetailItem.planEnddate}' pattern='yyyy-MM-dd'/></td>								
					    <td style="text-align: center" name="planInrate">${manufOrderDetailItem.planInrate}</td>
						<td style="text-align: center" name="preStartdate"><fmt:formatDate value='${manufOrderDetailItem.preStartdate}' pattern='yyyy-MM-dd'/></td>								
						<td style="text-align: center" name="preEnddate"><fmt:formatDate value='${manufOrderDetailItem.preEnddate}' pattern='yyyy-MM-dd'/></td>								
					    <td style="text-align: center" name="comments">${manufOrderDetailItem.comments}</td>
					    <td style="text-align: center">
					    	<a href="#" class="link del">删除</a>
					    	<a href="#" class="link edit">编辑</a>
					    </td>
						<input type="hidden" name="materialCode" value="${manufOrderDetailItem.materialCode}"/>
						<input type="hidden" name="materialCodenotation" value="${manufOrderDetailItem.materialCodenotation}"/>
						<input type="hidden" name="materialName" value="${manufOrderDetailItem.materialName}"/>
						<input type="hidden" name="materialSpec" value="${manufOrderDetailItem.materialSpec}"/>
						<input type="hidden" name="materialUnit" value="${manufOrderDetailItem.materialUnit}"/>
						<input type="hidden" name="materialNumber" value="${manufOrderDetailItem.materialNumber}"/>
						<input type="hidden" name="price" value="${manufOrderDetailItem.price}"/>
						<input type="hidden" name="sumPrice" value="${manufOrderDetailItem.sumPrice}"/>
					    <input type="hidden" name="deliveryEnddate" value="<fmt:formatDate value='${manufOrderDetailItem.deliveryEnddate}' pattern='yyyy-MM-dd'/>" class="inputText date"/>
					    <input type="hidden" name="predeliveryEnddate" value="<fmt:formatDate value='${manufOrderDetailItem.predeliveryEnddate}' pattern='yyyy-MM-dd'/>" class="inputText date"/>
						<input type="hidden" name="crafts" value="${manufOrderDetailItem.crafts}"/>
						<input type="hidden" name="craftAttachment" value="${manufOrderDetailItem.craftAttachment}"/>
						<input type="hidden" name="bom" value="${manufOrderDetailItem.bom}"/>
					    <input type="hidden" name="planStartdate" value="<fmt:formatDate value='${manufOrderDetailItem.planStartdate}' pattern='yyyy-MM-dd'/>" class="inputText date"/>
					    <input type="hidden" name="planEnddate" value="<fmt:formatDate value='${manufOrderDetailItem.planEnddate}' pattern='yyyy-MM-dd'/>" class="inputText date"/>
						<input type="hidden" name="planInrate" value="${manufOrderDetailItem.planInrate}"/>
					    <input type="hidden" name="preStartdate" value="<fmt:formatDate value='${manufOrderDetailItem.preStartdate}' pattern='yyyy-MM-dd'/>" class="inputText date"/>
					    <input type="hidden" name="preEnddate" value="<fmt:formatDate value='${manufOrderDetailItem.preEnddate}' pattern='yyyy-MM-dd'/>" class="inputText date"/>
						<input type="hidden" name="comments" value="${manufOrderDetailItem.comments}"/>
				    </tr>
				</c:forEach>
				<tr type="append">

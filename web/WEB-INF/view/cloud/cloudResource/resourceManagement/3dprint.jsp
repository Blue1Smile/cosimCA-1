...
function beginPrint(){
	  location.href='${ctx}/cloud/cloudResource/moreResource/3dsucess.ht';
}
	...
	<div id="model" class="bggraybox">
		...
		<ul>
			<li>
				...
				<iframe frameborder="0" width="100%" height="100%"  src="${ctx}/cloud/research/openFile.ht?fileId=<%=request.getParameter("fileId") %>">

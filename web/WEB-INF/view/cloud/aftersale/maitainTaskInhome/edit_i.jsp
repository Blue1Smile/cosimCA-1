		...
		<form id="maitainTaskForm" method="post" action="save.ht">
			...
			<td >
					...
					<tr>
						...
						<input size="35" type="hidden"   name="feedbackId" value="${maitainTask.feedbackId}"   />
						<input size="35" type="text" readonly="readonly"  name="feedbackName"   value="${maitainTask.feedbackName}"   class="inputText" validate="{required:true,maxlength:96}"/>

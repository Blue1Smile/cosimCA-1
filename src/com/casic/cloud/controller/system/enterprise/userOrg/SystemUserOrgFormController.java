package com.casic.cloud.controller.system.enterprise.userOrg;
 ...
 */
@Controller
@RequestMapping("/cloud/system/enterprise/userOrg/")
public class SystemUserOrgFormController extends BaseFormController
{
	@Resource

package com.casic.cloud.controller.system.enterprise.user;
 ...
 */
@Controller
@RequestMapping("/cloud/system/enterprise/user/")
public class SystemUserFormController extends BaseFormController
{
	@Resource

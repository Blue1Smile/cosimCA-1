...
/**
 * 对象功能:cloud_crowdsourcing_response_detail Model对象
 * 开发公司:中国航天科工集团
 * 开发人员:ziapple
 * 创建时间:2013-07-09 17:13:50
 */
public class CrowdsourcingResponseDetail extends BaseModel
{
	// ID
	protected Long  id;
	// 附件名
	...
	public CrowdsourcingResponseDetail(CrowdsourcingRequireDetail crowdsourcingRequireDetail) {
		super();
		this.id = id;
	...
	public CrowdsourcingResponseDetail() {
		super();
	...
	{
		if (!(object instanceof CrowdsourcingResponseDetail)) 
		{
			return false;
		}
		CrowdsourcingResponseDetail rhs = (CrowdsourcingResponseDetail) object;

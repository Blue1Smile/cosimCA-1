...
public class IndexInfo {
    ...
    public String getDdIndexName() {
        return ddIndexName;
    }

    public void setDdIndexName(String ddIndexName) {
    ...
    public String getDdIndexOptimum() {
        return ddIndexOptimum;
    }

    public void setDdIndexOptimum(String ddIndexOptimum) {
    ...
    public String getDdIndexLastestValue() {
        return ddIndexLastestValue;
    }

    public void setDdIndexLastestValue(String ddIndexLastestValue) {
        this.ddIndexLastestValue = ddIndexLastestValue;
    }

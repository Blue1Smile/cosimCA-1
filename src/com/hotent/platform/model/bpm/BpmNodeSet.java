...
public class BpmNodeSet extends BaseModel
{
	 ...
	 * 不允许运行时指定执行用户标志
	 */
	public static final Short ALLOW_SPEC_USR_NO = 1;
	
	/**
	 * 允许运行时指定执行企业标志
	 */
	public static final Short ALLOW_SPEC_USR_COMP = 2;
	/**
	 * 允许运行时指定执行本企业人员标志
	 */
	public static final Short ALLOW_SPEC_USR_SEL_COMP_USR = 3;
	...
	/////ht b
	/****
	 * 添加一个标志，用于表示节点在运行可指定的执行人的类型。
	 */
	@XmlAttribute
	protected Short allowSpecUsr =0;
	/////ht e

	public Short getAllowSpecUsr() {
		return allowSpecUsr;
	}
	public void setAllowSpecUsr(Short allowSpecUsr) {
		this.allowSpecUsr = allowSpecUsr;
	}

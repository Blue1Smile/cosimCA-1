package com.hotent.platform.controller.system;//package com.hotent.platform.controller.system;
//
...
//			resultMsg=getText("record.added","报表模板");
//		}else{
//			reportTemplate.setUpdateTime(new Date());
//			reportTemplateService.update(reportTemplate);
//			resultMsg=getText("record.updated","报表模板");
//		}

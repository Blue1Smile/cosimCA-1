...
<div id="all">
	...
	<div id="manager">
	  ...
	  <div id="help" class="bggraybox">
	    ...
	    <p class="w19 bottom_1"><strong>处理营销业务</strong></p>
	    <br />
	    <p class="f129 bottom_2"><br/> (1) 经销模式<br />
	      <img src="helpimg/helpimg054.jpg"/><br />
           (2) 代理模式<br />
	      <img src="helpimg/helpimg055.jpg"/><br />
          (3) 联营模式<br />
	      <img src="helpimg/helpimg056.jpg"/><br />
        </p>
      </div>
<div class="clear"></div>
	</div>

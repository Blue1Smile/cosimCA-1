				...
				<div class="panel-top">
					...
					<div class="panel-toolbar">
						<div class="toolBar">
							...
							<div class="group"><a class="link add"  href="edit.ht?demId=0">添加</a></div>
							<div class="l-bar-separator"></div>
					...
					<div class="panel-search">
							<form id="searchForm" method="post" action="list.ht">
									<div class="row">
												<span class="label">维度名称:</span><input type="text" name="Q_demName_SL"  class="inputText" value="${param['Q_demName_SL']}"/>
											
												<span class="label">维度描述:</span><input type="text" name="Q_demDesc_SL"  class="inputText" value="${param['Q_demDesc_SL']}"/>
									</div>
							</form>
					</div>
				</div>

...
<head>
	...
	<script type="text/javascript">
		function addNew(parentId,catKey,returnUrl,type)
		{
			if(parentId==0)
			{
				 $.ligerMessageBox.warn("请选择左边具体的分类!");
				 return;
			}
			else
			{
				...
				<div class="panel-body">
					<div class="panel-search">
							<form id="searchForm" method="post" action="list.ht">
									<div class="row">
												<span class="label">名称:</span><input type="text" name="Q_typeName_S"  class="inputText" value="${param['Q_typeName_S']}"/>
											
												<span class="label" style="display: none;">路径</span><input type="hidden" name="Q_nodePath_S"  class="inputText" value="${Q_nodePath_S }" readonly="readonly"/>
									</div>
							</form>
					</div>
					<br/>

...
<body>
	<div class="panel-top">
		...
		<div class="panel-toolbar">
			<div class="toolBar">
				<div class="group"><a class="link save" id="dataFormSave" url="save.ht" onclick="save(this)">保存</a></div>
	...
	<div id="layout1">
		...
		<div id="center" position="center" title="字段列表" style="position:relative;overflow:auto;">
			<div class="panel-top" style="position: fixed;">
				<div class="panel-toolbar">
					<div class="toolBar">
						<div class="group"><a id="addField" class="link add">增加字段</a></div>
						<div class="l-bar-separator"></div>
						<div class="group"><a id="backHistory" class="link undo">撤销<span style="font-weight:normal; color: gray; font-size: 10px;">(0)</span></a></div>
						<div class="l-bar-separator"></div>
						<div class="group"><a id="forwardHistory" class=" link redo">重做<span style="font-weight:normal; color: gray; font-size: 10px;">(0)</span></a></div>
						<div class="l-bar-separator"></div>

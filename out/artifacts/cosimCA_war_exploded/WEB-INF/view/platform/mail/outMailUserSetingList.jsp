			...
			<div class="panel">
				<div class="panel-top">
					...
					<div class="panel-search">
							<form id="searchForm" method="post" action="list.ht">
									<div class="row">
												<span class="label">账号名称:</span><input type="text" name="Q_userName_SL"  class="inputText" value="${param['Q_userName_SL']}"/>
											
												<span class="label">邮箱地址:</span><input type="text" name="Q_mailAddress_SL"  class="inputText" value="${param['Q_mailAddress_SL']}"/>
									</div>
							</form>
					</div>
				</div>
				<div class="panel-body">
					    ...
					    <display:table name="outMailUserSetingList" id="outMailUserSetingItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1"  class="table-grid">
							...
							<display:column title="管理" media="html" style="width:280px;text-align:center">
								<c:choose>

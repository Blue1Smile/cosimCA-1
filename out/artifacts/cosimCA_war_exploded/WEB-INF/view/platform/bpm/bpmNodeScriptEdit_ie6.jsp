...
<script type="text/javascript">
	...
	function showResult(responseText) {
		...
		if (!obj.isSuccess()) {
			...
			$.ligerMessageBox.success('提示信息', "流程事件脚本编辑成功!",function() {
				window.close();
			});
		}
	}
							  ...
							  <div tabid="startScript" title="前置脚本">
							     ...
							     <table class="table-detail" cellpadding="0" cellspacing="0" border="0">
											<tr>
												<th width="20%">脚本描述:<span class="required">*</span> </th>
												<td>
													该事件在<span class="red">启动该任务</span>时执行，用户可以使用<span class="red">taskInfo</span>做操作。
													例如设置流程变量:taskInfo.setVariable("total", 100);
				              ...
				              <div tabid="endScript" title="后置脚本" >
							     <table class="table-detail" cellpadding="0" cellspacing="0" border="0">
											<tr>
												<th width="20%">脚本描述:<span class="required">*</span> </th>
												<td>
													该事件在<span class="red">任务完成</span>时执行，用户可以使用<span class="red">taskInfo</span>做操作。
													例如设置流程变量:taskInfo.setVariable("total", 100);
													<input type="hidden"   name="scriptType" value="2" />
				              ...
				              <div tabid="assignScript" title="分配脚本" >
							     <table class="table-detail" cellpadding="0" cellspacing="0" border="0">
											<tr>
												<th width="20%">脚本描述:<span class="required">*</span> </th>
												<td>
													该事件在任务<span class="red">设置执行人</span>时执行，用户可以使用<span class="red">taskInfo</span>做操作。
													例如设置流程变量:taskInfo.setVariable("total", 100);

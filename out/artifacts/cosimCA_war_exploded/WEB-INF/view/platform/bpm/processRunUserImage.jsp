<%@page import="com.hotent.core.bpm.graph.ShapeMeta"%>
<%
...
<script type="text/javascript">
	...
	function getTableHtml(taskId){		
		...
		if(aryOptions.length==0)return false;
 		var html=['<div style="height:240px;width:288px;overflow:auto">'];
		for(var i=0;i<aryOptions.length;i++){
			...
			sb.append('<table class="table-taskInfo" cellpadding="0" cellspacing="0" border="0">');
...
<div class="panel">
	...
	<c:choose>
		...
		<f:tab curTab="任务流程执行人员明细" tabName="taskInfo"/>
		</c:when>
		<c:otherwise>
		<f:tab curTab="流程示意图" tabName="process"/>
		</c:otherwise>
	</c:choose>
	</c:if>

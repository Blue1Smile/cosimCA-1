	...
	<div class="panel-body">
		<form id="purOrderForm" method="post" action="save2.ht">
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0" type="main">
				...
				<tr>
					<th width="20%">币种: </th>
					<td><input type="text" id="currencyType" name="currencyType" value="${purOrder.currencyType}"  class="inputText" validate="{required:false}"  /></td>
					<th width="20%">总金额: </th>
			    ...
			    <tr>
					...
					<td><input type="text" id="purenterpId"  readonly="readonly"  name="purenterpId" value="${purOrder.purenterpId}"  class="inputText" validate="{required:false,number:true }"  /></td>
					<th width="20%">采购企业名称: </th>
					<td><input type="text" id="purenterpName"  readonly="readonly" name="purenterpName" value="${purOrder.purenterpName}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
			
				
				<tr>
					<th width="20%">采购商联系人姓名: </th>
					<td><input type="text" id="purenterpUsername" readonly="readonly" name="purenterpUsername" value="${purOrder.purenterpUsername}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				...
				<tr>
					...
					<td><input type="text" id="suppenterpUserid"  readonly="readonly" name="suppenterpUserid" value="${purOrder.suppenterpUserid}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>

...
<div class="panel">
	...
	<div class="panel-body">
		<form id="purOrderForm" method="post" action="save.ht">
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0" type="main">
				...
				<tr>
					...
					<td><input type="text" id="suppenterpName" name="suppenterpName" value="${purOrder.suppenterpName}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
		...
		<!-- 	<tr>
				...
				<tr>
					...
					<td><input type="text" id="sourceformId" name="sourceformId" value="${purOrder.sourceformId}"  class="inputText" validate="{required:false,number:true }"  /></td>
				</tr>
				<tr>
					<th width="20%">suppenterp_id: </th>
					<td><input type="text" id="suppenterpId" name="suppenterpId" value="${purOrder.suppenterpId}"  class="inputText" validate="{required:false,number:true }"  /></td>
				</tr>
				<tr>
					<th width="20%">purenterp_userid: </th>
					<td><input type="text" id="purenterpUserid" name="purenterpUserid" value="${purOrder.purenterpUserid}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
					<tr>
					<th width="20%">suppenterp_userid: </th>
					<td><input type="text" id="suppenterpUserid" name="suppenterpUserid" value="${purOrder.suppenterpUserid}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
				<tr>
					<th width="20%">receiver_id: </th>
					<td><input type="text" id="receiverId" name="receiverId" value="${purOrder.receiverId}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
				<tr>
					<th width="20%">receivewarehouse_id: </th>
					<td><input type="text" id="receivewarehouseId" name="receivewarehouseId" value="${purOrder.receivewarehouseId}"  class="inputText" validate="{required:false,number:true }"  /></td>
				</tr>
				 -->	
				<tr>
	...
	<form id="purOrderDetailForm" style="display:none">
		...
		<!-- 	<tr>
				<th width="20%">delivery_enddate: </th>

...
/* 		function showResponse(responseText) {
		...
		function selectedProvider(quoteId){
			$.ajax({
				   type: "POST",
				   url:  "${ctx}/cloud/purchase/purOptimize/selectedProvider2.ht",
	...
	<div class="panel-body">
		<form id="purOptimizeForm" method="post" action="save.ht">
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0" type="main">
				...
				<tr>
					...
					<td><input type="text" id="supplierName" name="supplierName"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
				<tr>
					<th width="20%">中标供应商ID: </th>
					<td><input type="text" id="supplierId" name="supplierId"   class="inputText" validate="{required:false,maxlength:96}"  /></td>
		...
		<table class="table-grid table-list" cellpadding="1" cellspacing="1">
			...
			<c:forEach items="${purBidPlanDetailList}" var="purBidPlanDetailItem" varStatus="status">
				<tr>
						<input type="hidden" id="detailId" name="detailId" value="${purBidPlanDetailItem.id}"  class="inputText"/>

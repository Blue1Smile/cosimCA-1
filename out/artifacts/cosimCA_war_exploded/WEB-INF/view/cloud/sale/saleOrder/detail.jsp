		...
		<form id="saleOrderForm" method="post" action="save.ht">
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0" type="main">
				<tr>
					...
					<td><input type="text" id="code" name="code" value="${saleOrder.code}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
				<tr>
					<th width="20%">制单日期: </th>
					<td><input type="text" id="operateDate" name="operateDate" value="<fmt:formatDate value='${saleOrder.operateDate}' pattern='yyyy-MM-dd'/>" class="inputText date" validate="{date:true}" /></td>
				...
				<tr>
					...
					<tr>
					<th width="20%">币种: </th>
					<td><input type="text" id="currencyType" name="currencyType" value="${saleOrder.currencyType}"  class="inputText" validate="{required:false}"  /></td>
					<th width="20%">总金额: </th>
					<td><input type="text" id="sumPrice" name="sumPrice" value="${saleOrder.sumPrice}"  class="inputText" validate="{required:false}"  /></td>
				</tr>
			
	<!-- 	<td><input type="hidden" id="currencyType" name="currencyType" value="${saleOrder.currencyType}"  class="inputText" validate="{required:false,maxlength:96}"  /></td> -->			
				<tr>
					<th width="20%">采购企业ID: </th>
					<td><input type="text" id="purenterpId" name="purenterpId"  readonly="readonly" value="${saleOrder.purenterpId}"  class="inputText" validate="{required:false,number:true }"  /></td>
					<th width="20%">采购企业名称: </th>
					<td><input type="text" id="purenterpName" name="purenterpName"  readonly="readonly" value="${saleOrder.purenterpName}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
		...
		<!--	<tr>
				...
				<tr>
					...
					<td><input type="text" id="suppenterpId" name="suppenterpId" value="${saleOrder.suppenterpId}"  class="inputText" validate="{required:false,number:true }"  /></td>
				</tr>

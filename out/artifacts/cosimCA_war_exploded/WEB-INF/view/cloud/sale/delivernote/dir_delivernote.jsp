	...
	<div class="panel-body">
		<form id="delivernoteForm" method="post" action="save.ht">
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0" type="main">
				...
				<tr>
					<th width="20%">制单日期: </th>
					<td><input type="text" id="operateDate" name="operateDate" readonly="readonly" value="<fmt:formatDate value='${delivernote.operateDate}' pattern='yyyy-MM-dd'/>" class="inputText date" validate="{date:true}" /></td>
				...
				<tr>
					...
					<td style="display:none;"><input type="text" id="purenterpId"  readonly="readonly" name="purenterpId" value="${delivernote.purenterpId}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
				...
				<tr>
					...
					<td style="display:none;"><input type="text" id="suppenterpId"  readonly="readonly" name="suppenterpId" value="${delivernote.suppenterpId}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
			...
			<!--	<tr>
				...
				<tr>
					...
					<td><input type="text" id="deliverwarehouseName" name="deliverwarehouseName" value="${delivernote.deliverwarehouseName}"  class="inputText" validate="{required:false,maxlength:768}"  /><a href="#" onclick="add_archive()"  class="link detail">选择</a></td>
		...
		<!--  		<tr>
				...
				<input type="hidden" id="operatorId" name="operatorId" value="${delivernote.operatorId}"  class="inputText" validate="{required:false,maxlength:96}"  />
				<tr style="display:none">

		...
		<form id="delivernoteForm" method="post" action="save.ht">
			...
			<!--	<tr>
				...
				<tr>
					...
					<td><input type="text" id="deliverwarehouseName" name="deliverwarehouseName" value="${delivernote.deliverwarehouseName}"  class="inputText" validate="{required:false,maxlength:768}"  /></td>
				</tr>

	...
	<div class="panel-body">
		<form id="logisticPlanForm" method="post" action="save.ht">
			<table class="table-detail" id="logisticPlanMain" cellpadding="0" cellspacing="0" border="0" type="main">
				...
				<tr>
					<th width="20%">发货日期: </th>
					<td><input type="text" id="forecastPostDate" name="forecastPostDate" value="<fmt:formatDate value='${logisticPlan.forecastPostDate}' pattern='yyyy-MM-dd'/>" class="inputText" validate="{date:true}" /></td>
					<th width="20%">收货日期: </th>
					<td><input type="text" id="forecastReceiveDate" name="forecastReceiveDate" value="<fmt:formatDate value='${logisticPlan.forecastReceiveDate}' pattern='yyyy-MM-dd'/>" class="inputText" validate="{date:true}"/></td>
				</tr>
				<tr style="display:none;">

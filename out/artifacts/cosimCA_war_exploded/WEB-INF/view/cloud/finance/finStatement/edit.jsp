			...
			if (obj.isSuccess()) {
				$.ligerMessageBox.confirm("提示信息", obj.getMessage()+",是否继续操作", function(rtn) {
					if(rtn){
						...
						window.location.href = "${ctx}/cloud/finance/finStatement/list.ht";
					}
				});
			} else {
...
<div class="panel">
	...
	<div class="panel-body">
		<form id="finStatementForm" method="post" action="save.ht">
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0" type="main">
				...
				<tr>
					...
					<input type="hidden" id="remark1" name="remark1" value="0"  class="inputText"   />
				</tr>
				<tr>
				...
				<tr>	
					<th width="20%">收款企业: </th>
					<td><input type="text" id="payeeenterpName" name="payeeenterpName" value="${finStatement.payeeenterpName}"  class="inputText" validate="{required:true,maxlength:96}"  /></td>
					<th width="20%">收款人: </th>
					<td><input type="text" id="payeeenterpUsername" name="payeeenterpUsername" value="${finStatement.payeeenterpUsername}"  class="inputText" validate="{required:true,maxlength:96}"  /></td>
				</tr>
			</table>

       		...
       		<div class="panel-top">
	       		<div class="panel-toolbar">
					<div class="toolBar">
						...
						<c:choose>
						  	<c:when test="${action=='global' }">
						  		<div class="group"><a class="link add"  href="${ctx}/cloud/config/enterprise/user/edit.ht?orgId=${orgId}">新增人员</a></div>
						  	</c:when>
						  	<c:otherwise>
						  		<div class="group"><a class="link add"  href="${ctx}/cloud/config/enterprise/user/editGrade.ht?orgId=${orgId}">新增人员</a></div>
						  	</c:otherwise>
					   </c:choose>
						<div class="l-bar-separator"></div>
						...
						<div class="group"><a class="link del" action="${ctx}/cloud/config/enterprise/userOrg/del.ht">移除</a></div>
					</div>	
				</div>
			...
			<div class="panel-body">
				    ...
				    <display:table name="sysOrgUserList" id="sysOrgItem" requestURI="userList.ht" sort="external" cellpadding="1" cellspacing="1" export="false"  class="table-grid">
						...
						<display:column title="管理" media="html" >
							<a href="${ctx}/cloud/config/enterprise/userOrg/del.ht?userOrgId=${sysOrgItem.userOrgId}" class="link del">删除</a>
							<a href="${ctx}/cloud/config/enterprise/user/get.ht?userId=${sysOrgItem.userId}" class="link detail">明细</a>
							<%--
							<c:choose>

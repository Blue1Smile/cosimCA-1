...
<!-- 				</tr>
				<tr> 
					...
					<td>
					<input type="hideen" id="operatorId" name="operatorId" value="${manufOrder.operatorId}"  class="inputText" validate="{required:false,number:true }"  />
 					</td>
				</tr> -->
				<tr>
					<th width="20%">制单人: </th>
					<td>
					    <input type="hidden" id="operatorId" name="operatorId" value="${manufOrder.operatorId}"  class="inputText" validate="{required:false,number:true }"  />
					    <input type="text" id="operatorName" name="operatorName" value="${manufOrder.operatorName}"  class="inputText" validate="{required:false,maxlength:96}"  />
					 </td>
<!-- 				</tr>
				<tr> -->
					<th width="20%">制单日期: </th>
...
<%-- 				<tr>
				...
				<tr>
					<th width="20%">委托企业: </th>
					<td>
						<input type="hidden" id="enquiryenterpriseId" name="enquiryenterpriseId" value="${manufOrder.enquiryenterpriseId}"  class="inputText" validate="{required:false,number:true }"  />
						<input type="text" id="enquiryenterpriseName" name="enquiryenterpriseName" value="${manufOrder.enquiryenterpriseName}"  class="inputText" validate="{required:false,maxlength:96}"  />
					</td>
<%-- 				</tr>
				<tr>
...
<%--				</tr>
				...
				<tr>--%>
					...
					<td>
					    <input type="hidden" id="sourceformId" name="sourceformId" value="${manufOrder.sourceformId}"  class="inputText" validate="{required:false,number:true }"  />
					    <input type="text" id="sourceformCode" name="sourceformCode" value="${manufOrder.sourceformCode}"  class="inputText" validate="{required:false,maxlength:96}"  />
					</td>
				</tr>
...
<%-- 				<tr>
				...
				<tr>
					...
					<td>
						<input type="hidden" id="enterpriseId" name="enterpriseId" value="${manufOrder.enterpriseId}"  class="inputText" validate="{required:false,number:true }"  />
						<input type="text" id="enterpriseName" name="enterpriseName" value="${manufOrder.enterpriseName}"  class="inputText" validate="{required:false,maxlength:96}"  />
					</td>
<%-- 				</tr>
				<tr>
				...
				<tr> --%>
					...
					<td>
						<input type="hidden" id="enterpriseUserid" name="enterpriseUserid" value="${manufOrder.enterpriseUserid}"  class="inputText" validate="{required:false,number:true }"  />
						<input type="text" id="enterpriseUsername" name="enterpriseUsername" value="${manufOrder.enterpriseUsername}"  class="inputText" validate="{required:false,maxlength:96}"  />
					</td>
				</tr>
...
<%-- 				<tr>
				...
				<tr>
					...
					<td>
						<input type="hidden" id="receivewarehouseId" name="receivewarehouseId" value="${manufOrder.receivewarehouseId}"  class="inputText" validate="{required:false,number:true }"  />
						<input type="text" id="receivewarehouseName" name="receivewarehouseName" value="${manufOrder.receivewarehouseName}"  class="inputText" validate="{required:false,maxlength:96}"  />
					</td>
<!-- 				</tr>
				<tr> -->
...
<%-- 				<tr>
				...
				<tr>
					...
					<td>
						<input type="hidden" id="receivewarehouseUserid" name="receivewarehouseUserid" value="${manufOrder.receivewarehouseUserid}"  class="inputText" validate="{required:false,number:true }"  />
						<input type="text" id="receivewarehouseUsername" name="receivewarehouseUsername" value="${manufOrder.receivewarehouseUsername}"  class="inputText" validate="{required:false,maxlength:96}"  />
					</td>
				</tr>
...
<%-- 				<tr>
				...
				<tr>
					<th width="20%">发货仓库: </th>
					<td>
						<input type="hidden" id="deliverwarehouseId" name="deliverwarehouseId" value="${manufOrder.deliverwarehouseId}"  class="inputText" validate="{required:false,number:true }"  />
						<input type="text" id="deliverwarehouseName" name="deliverwarehouseName" value="${manufOrder.deliverwarehouseName}"  class="inputText" validate="{required:false,maxlength:96}"  />
					</td>
<!-- 				</tr>
				<tr> -->
...
<%-- 				<tr>
				...
				<tr> 
					...
					<td>
						<input type="hidden" id="deliverwarehouseUserid" name="deliverwarehouseUserid" value="${manufOrder.deliverwarehouseUserid}"  class="inputText" validate="{required:false,number:true }"  />
						<input type="text" id="deliverwarehouseUsername" name="deliverwarehouseUsername" value="${manufOrder.deliverwarehouseUsername}"  class="inputText" validate="{required:false,maxlength:96}"  />
					</td>
				</tr>
...
<!-- 				</tr>
				<tr> -->
					<th width="20%">备注: </th>
					<td><input type="range" id="comments" name="comments" value="${manufOrder.comments}"  class="inputText" validate="{required:false,maxlength:768}"  /></td>
				</tr>
			</table>

		...
		<form id="manufsuppliesDelivernoteForm" method="post" action="save.ht">
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0" type="main">
				...
				<tr style="display:none;">
					<th width="20%">物料ID:</th>
					<td><input type="text" id="suppliesId" name="suppliesId" value="${manufsuppliesDelivernote.suppliesId}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
				<tr>
					<th width="20%">制单日期: </th>
				...
				<tr>
					...
					<td><input type="text" id="recenterpName" name="recenterpName" value="${manufsuppliesDelivernote.recenterpName}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
			
					<th width="20%">接收企业联系人姓名: </th>
					<td><input type="text" id="recenterpUsername" name="recenterpUsername" value="${manufsuppliesDelivernote.recenterpUsername}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
				
				<tr>
					<th width="20%">供应企业名称: </th>
					<td><input type="text" id="suppenterpName" name="suppenterpName" value="${manufsuppliesDelivernote.suppenterpName}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				
					<th width="20%">供应企业联系人姓名: </th>
					<td><input type="text" id="suppenterpUsername" name="suppenterpUsername" value="${manufsuppliesDelivernote.suppenterpUsername}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
				<tr>
					<th width="20%">收货仓库名称: </th>
					<td><input type="text" id="receivewarehouseName" name="receivewarehouseName" value="${manufsuppliesDelivernote.receivewarehouseName}"  class="inputText" validate="{required:false,maxlength:768}"  /></td>
				
					<th width="20%">收货仓库详细地址: </th>
					<td><input type="text" id="receivewarehouseAddress" name="receivewarehouseAddress" value="${manufsuppliesDelivernote.receivewarehouseAddress}"  class="inputText" validate="{required:false,maxlength:768}"  /></td>
				</tr>
				<tr>
					<th width="20%">收货人姓名: </th>
					<td><input type="text" id="receiverName" name="receiverName" value="${manufsuppliesDelivernote.receiverName}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				...
				<tr>
					...
					<td><input type="text" id="deliverwarehouseName" name="deliverwarehouseName" value="${manufsuppliesDelivernote.deliverwarehouseName}"  class="inputText" validate="{required:false,maxlength:768}"  /></td>
				
					<th width="20%">发货仓库详细地址: </th>
					<td><input type="text" id="deliverwarehouseAddress" name="deliverwarehouseAddress" value="${manufsuppliesDelivernote.deliverwarehouseAddress}"  class="inputText" validate="{required:false,maxlength:768}"  /></td>
				</tr>
				<tr>
					<th width="20%">发货人姓名: </th>
					<td><input type="text" id="delivererName" name="delivererName" value="${manufsuppliesDelivernote.delivererName}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>

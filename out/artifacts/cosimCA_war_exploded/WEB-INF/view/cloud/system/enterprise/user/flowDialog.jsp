		...
		*/
		...
		function handPosClick(event, treeId, treeNode){
			...
			if(rtn){
				...
				var url="${ctx}/cloud/system/enterprise/user/selector.ht";
		...
		function load_Org_Tree(){
			...
			var setting = {
				...
				async: {
					enable: true,
					url:"${ctx}/cloud/system/enterprise/org/getTreeData.ht?demId="+value,
		...
		function load_Rol_Tree(){
			...
			function load_Onl_Tree(){
				...
				var url= "${ctx}/cloud/system/enterprise/org/getTreeOnlineData.ht";
...
<body>
	<div id="defLayout">
		...
		<div position="center">
			...
			<iframe id="userListFrame" name="userListFrame" height="90%" width="100%" frameborder="0" src="${ctx}/cloud/system/enterprise/user/selector.ht?isSingle=${isSingle}"></iframe>
		</div>

		...
		<form id="crowdsourcingAgreementForm" method="post" action="save.ht">
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0" type="main">
				<tr>
					...
					<td><input type="text" id="code" name="code" value="${crowdsourcingAgreement.code}"  class="inputText" validate="{required:false,maxlength:192}"  /></td>
				</tr>
				<tr>
					<th width="20%">制单人ID: </th>
					<td><input type="text" id="operaterId" name="operaterId" value="${crowdsourcingAgreement.operaterId}"  class="inputText" validate="{required:false,number:true }"  /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" id="operaterEnterpId" name="operaterEnterpId" value="${crowdsourcingAgreement.operaterEnterpId}"  class="inputText" validate="{required:false,number:true }"  /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" id="sourceformCrowdsourcingId" name="sourceformCrowdsourcingId" value="${crowdsourcingAgreement.sourceformCrowdsourcingId}"  class="inputText" validate="{required:false,number:true }"  /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" id="receiveOrgId" name="receiveOrgId" value="${crowdsourcingAgreement.receiveOrgId}"  class="inputText" validate="{required:false,number:true }"  /></td>
				</tr>
				<tr>
					<th width="20%">接包方组织名称: </th>
					<td><input type="text" id="receiveOrgName" name="receiveOrgName" value="${crowdsourcingAgreement.receiveOrgName}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
				<tr>
					<th width="20%">接包人ID: </th>
					<td><input type="text" id="receiverId" name="receiverId" value="${crowdsourcingAgreement.receiverId}"  class="inputText" validate="{required:false,number:true }"  /></td>
				</tr>
				<tr>
					<th width="20%">接包人名称: </th>
					<td><input type="text" id="receiverName" name="receiverName" value="${crowdsourcingAgreement.receiverName}"  class="inputText" validate="{required:false,maxlength:96}"  /></td>
				</tr>
				<tr>
					<th width="20%">协议价格: </th>
					<td><input type="text" id="agreePrice" name="agreePrice" value="${crowdsourcingAgreement.agreePrice}"  class="inputText" validate="{required:false}"  /></td>
				</tr>
				<tr>
					<th width="20%">币种: </th>
				...
				<tr>
					...
					<td><input type="text" id="materialId" name="materialId" value="${crowdsourcingAgreement.materialId}"  class="inputText" validate="{required:false,number:true }"  /></td>
				</tr>
				<tr>
			...
			<table class="table-grid table-list" cellpadding="1" cellspacing="1" id="crowdsourcingAgreementDetail" formType="window" type="sub">
				...
				<c:forEach items="${crowdsourcingAgreementDetailList}" var="crowdsourcingAgreementDetailItem" varStatus="status">
				    <tr type="subdata">
					    <td style="text-align: center" name="attachmentName">${crowdsourcingAgreementDetailItem.attachmentName}</td>
					    ...
					    <td style="text-align: center" name="uploadId">${crowdsourcingAgreementDetailItem.uploadId}</td>

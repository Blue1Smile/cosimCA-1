		...
		<form id="jobCardForm" method="post" action="complete.ht">			
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0" type="main">
				...
				<tr>
					...
					<td colspan="3"><textarea cols="110" rows="3" type="text" id="reason" name="reason"  class="inputText" validate="{required:false,maxlength:300}" >${jobCard.reason}</textarea></td>
				</tr>

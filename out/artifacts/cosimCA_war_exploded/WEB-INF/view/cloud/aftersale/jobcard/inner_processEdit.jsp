	...
	<div class="panel-top">
		...
		<div class="panel-toolbar">
			<div class="toolBar">
				...
				<div class="group"><a class="link back" href="${ctx}/cloud/aftersale/taskm/get.ht?id=${taskM.id}" target="_blank">查看维修单</a></div>
			</div>
		</div>
	</div>
		...
		<form id="jobCardForm" method="post" action="complete.ht">			
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0" type="main">
				...
				<tr>
					...
					<td colspan="3"><input size="35" type="text" id="taskid" name="taskid" value="${taskM.id}" class="inputText" validate="{required:true,maxlength:96}"/></td>
				</tr>
				<%-- <tr>
				...
				<tr>
					...
					<td colspan="3"><textarea  cols="110" rows="3" type="text" id="descn" name="descn"  class="inputText" validate="{required:false,maxlength:96}"  >${taskM.descn}</textarea></td>
				</tr>
				
				<tr>
					<th style="width:120px">故障原因:  <span class="required"></span></th>
					<td colspan="3"><textarea  cols="110" rows="3" type="text" id="reason" name="reason"   class="inputText" validate="{required:false,maxlength:300}"  ></textarea></td>
				</tr>
				<tr>
					<th style="width:120px">工作内容:  <span class="required"></span></th>
					<td colspan="3"><textarea cols="110" rows="3" type="text" id="content" name="content"  class="inputText" validate="{required:false,maxlength:765}"  >${jobCard.content}</textarea></td>
				</tr>
				<tr>
					<th style="width:120px">维修人员:  <span class="required"></span></th>
					<td><input size="35" type="text" id="man" name="man" value="${jobCard.man}"  class="inputText" validate="{required:true,maxlength:96}"  /></td>
				...
				<tr>
					...
					<td colspan="3"><input type="text" id="manmoney" name="manmoney" value="${jobCard.manmoney }"  class="inputText" validate="{required:true,number:true}" /></td>
				</tr>
			...
			<table class="table-grid table-list" cellpadding="1" cellspacing="1" id="jobCardDetail" formType="window" type="sub">
				...
				<c:forEach items="${jobCardDetailList}" var="jobCardDetailItem" varStatus="status">
				    <tr type="subdata">
					    <td style="text-align: center" name="taskid">${jobCardDetailItem.seq}</td>

...
<!-- 						<a href="#" onclick="preview()" class="link detail" ">请选择</a> -->
					...
					<tr>
						<th>问题描述</th>
						<td colspan="3"><textarea  id="descn" readonly class="r" cols="95" rows="5" name="descn"  class="inputText" validate="{required:false,maxlength:96}">${maitainTask.descn}</textarea></td>
					</tr>
					<tr>

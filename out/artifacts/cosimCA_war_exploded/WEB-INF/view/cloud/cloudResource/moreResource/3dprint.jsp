...
function beginPrint(){
	  location.href='${ctx}/cloud/cloudResource/resourceManagement/moreResource.ht?type=3dsuccess';
}
	...
	<div id="model" class="bggraybox">
		...
		<ul>
			<li>
				...
				<%-- <iframe width="100%" height="100%" frameborder="0" src="${ctx}/cloud/research/openFile.ht?fileId=10000023110003"> --%>
				<iframe frameborder="0" width="100%" height="100%"  src="${ctx}/cloud/research/openFile.ht?fileId=10000024560000">
              ...
              <div class="bom">
                ...
                <div class="pom">
				  <div class="pom_desc">
				    <h5>&nbsp;</h5>
                    <h4>
                        <input type="image" src="${ctx}/skins/btn_buy.jpg" onclick="beginPrint();"/>
                      <br />
                       &nbsp;<br />
                    </h4>
				  </div>

...
package com.${org}.${system}.service.${module};
...
import com.${org}.${system}.dao.${module}.${class}Dao;
<#if subtables?exists && subtables?size != 0>
	<#list subtables as table>
import com.${org}.${system}.model.${table.variables.module}.${table.variables.class};
import com.${org}.${system}.dao.${table.variables.module}.${table.variables.class}Dao;
	</#list>
</#if>
